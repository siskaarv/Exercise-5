...
void FlashGreenLedTask(void const * argument);
void FlashRedLedTask(void const * argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* definition and creation of GreenLedFlashingTask */
   osThreadDef(greenLedTask, FlashGreenLedTask, osPriorityNormal, 0, 128);
   greenLedTaskHandle = osThreadCreate(osThread(greenLedTask), NULL);

   /* definition and creation of RedLedFlashingTask */
   osThreadDef(redLedTask, FlashRedLedTask, osPriorityAboveNormal, 0, 128);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(LED_GPIO_PORT, BLUE_LED_PIN | GREEN_LED_PIN | RED_LED_PIN, GPIO_PIN_RESET);
